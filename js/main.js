...
$(function() {
  var bookmark = {
    data: [{
      name: 'flysocks',
      link: 'https://flysocks.xyz/auth/login',
      icon: 'https://flysocks.xyz/favicon.ico',
    }, {
      name: '优惠券',
      ...
      icon: 'https://www.ctfhub.com/img/ctfhub_logo.0265db54.svg',
    }, {
      name: '知乎',
  ...
  $(document).click(function(e) {
    ...
    for (var i = 0; i < search.data.length; i++) {
      if (id == search.data[i].name) {
        document.getElementById("state").innerHTML = "<a href='https://github.com/20011004'><img style='width:300px;' src='img/" + search.data[i].name + ".png'></a>";
